<h1>1492 - Time Needed to Inform All Employees</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/time-needed-to-inform-all-employees/">time-needed-to-inform-all-employees</a></h2><p>A company has <code>n</code> employees with a unique ID for each employee from <code>0</code> to <code>n - 1</code>. The head of the company is the one with <code>headID</code>.</p>
