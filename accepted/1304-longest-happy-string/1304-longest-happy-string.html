<h1>1304 - Longest Happy String</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/longest-happy-string/">longest-happy-string</a></h2><p>A string <code>s</code> is called <strong>happy</strong> if it satisfies the following conditions:</p>
